				...
				<div class="box">
					<div class="box-body">
						...
						<div style="text-align:left;">
					        ...
					        <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>anuncios';">Anúncios</button>
							...
							<?php
								...
								foreach ($lista as $key => $value) {
									...
									<tr>
										...
										<td $linklinha >".$value['grupo']."</td>
										<td $linklinha >".$value['valor']."</td> 
										<td $linklinha >".$value['anuncios_n']."</td>
										<td $linklinha >".$value['anuncios']."</td>
										<td $linklinha >".$value['vendidos']."</td>
									</tr>
									";
